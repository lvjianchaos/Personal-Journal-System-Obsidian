...
AND date >= date(<% moment(tp.file.title, 'YYYY-MM').startOf('month').add(0,
'days').format("YYYY-MM-DD") %>)
AND date <= date(<% moment(tp.file.title, 'YYYY-MM').startOf('month').add(1,
'months').add(-1, 'days').format("YYYY-MM-DD") %>)
...
month:
	...
	color: green
	initMonth: <% moment(tp.file.title,'YYYY-MM').format('YYYY-MM') %>
